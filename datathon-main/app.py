...
if model and mostrar_analise:
    # Ordem correta conforme scaler.feature_names_in_
    feature_order = ["ian", "ida", "ieg", "ips", "ipp", "iaa", "ipv"]
    ...
    "iaa": iaa,
    "ipv": ipv
    }])[feature_order].astype(float)

    # Aplicar scaler
    input_scaled = scaler.transform(input_data)

    # Predição
    prob_risco = model.predict_proba(input_scaled)[0][1]
